package com.ignoreos.jvmqq.Utils;
import java.io.*;
import java.util.*;
import java.nio.*;
...
import com.ignoreos.jvmqq.Window.OutPutWindow;
import com.ignoreos.jvmqq.sdk.QQMessage;
import com.ignoreos.jvmqq.Message.PictureKeyStore;
import com.ignoreos.jvmqq.Robot.LuaQQRobot;
import com.ignoreos.jvmqq.Window.ChatListWindow;
import com.ignoreos.jvmqq.Window.ChatWindow;
import com.ignoreos.jvmqq.sdk.*;
import org.json.*;
...
public class Util
{
	...
	public static Friend_List parsefrienddata(String data)
	{
		...
		try
		{
			...
			JSONArray root_result_0_mems = root.getJSONObject("result").getJSONObject("3").getJSONArray("mems");
